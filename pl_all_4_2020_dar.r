#Source is from https://www.census.gov/programs-surveys/decennial-census/about/rdo/summary-files.html#P1
library(tidyverse)
# -----------------------------
...
onondagacounty <- combine %>%
  filter(grepl(36067,GEOCODE)) 
write.csv(onondagacounty, 'onondagacounty2020census.csv', row.names = FALSE)
